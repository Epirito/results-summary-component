        ...
        <div class="hidden sm:block">
          <nav class="invisible sm:visible flex sm:flex-row items-center justify-between">
            ...
            <div class="flex space-x-4">
              ...
              <a
                href=""
                class="border-1 px-4 py-1 rounded-xl text-gray-500 font-semibold hover:text-black border-gray-500 hover:border-black"
              >
                Register
              </a>
            </div>
        ...
        <div class="sm:hidden">
          <nav class="top-0 visible sm:invisible flex items-center">
            ...
            <div class="w-1/2 flex justify-right items-center py-4">
              <button class="h-auto">
                <img class="p-4" src="/intro-dropdown/icon-menu.svg" />
              </button>
            </div>
          </nav>
        </div>
